...
:PARSE_GIT_STRING
:: --------------------
FOR /F "tokens=*" %%A IN ('"git describe --tags --abbrev=6 HEAD"') DO (
  SET strFILE_VERSION=%%A
)
...
ECHO #define GEN_GIT_VER_VERSION_STRING   "%strFILE_VERSION%\0" >> "%HEADER_OUT_FILE%"
ECHO #define GEN_GIT_VER_DIGITAL_VERSION  %csvFILE_VERSION% >> "%HEADER_OUT_FILE%"
ECHO #define GEN_GIT_VER_VERSION_HEX      %hexFILE_VERSION% >> "%HEADER_OUT_FILE%"
ECHO #define GEN_GIT_VER_COMMENT_STRING   "%strCOMMENT%\0" >> "%HEADER_OUT_FILE%"
ECHO #define GEN_GIT_VER_PRIVATE_FLAG     %fPRIVATE% >> "%HEADER_OUT_FILE%"
ECHO #define GEN_GIT_VER_PRIVATE_STRING   "%strPRIVATE%\0" >> "%HEADER_OUT_FILE%"
ECHO #define GEN_GIT_VER_PATCHED_FLAG     %fPATCHED% >> "%HEADER_OUT_FILE%"
ECHO #define GEN_GIT_VER_PRERELEASE_FLAG  %fPRE_RELEASE% >> "%HEADER_OUT_FILE%"
ECHO #define GET_GIT_VER_BRANCH			  "%strGITBRANCH%\0" >> "%HEADER_OUT_FILE%"
ECHO #define GET_GIT_VER_USERNAME		  "%strGITUSERNAME%\0" >> "%HEADER_OUT_FILE%"
