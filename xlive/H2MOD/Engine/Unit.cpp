...
namespace Engine
{
	namespace Unit
	{
		void __cdecl remove_equipment(datum unit_idx)
		{
			...
			unit_reset_equipment_t p_unit_reset_equipment = Memory::GetAddress<unit_reset_equipment_t>(0x1441E0, 0x133030);
		...
		signed int __cdecl inventory_next_weapon(datum unit_idx)
		{
			...
			unit_inventory_next_weapon_t p_unit_inventory_next_weapon = Memory::GetAddress<unit_inventory_next_weapon_t>(0x139E04, 0x0);
		...
		bool __cdecl assign_equipment_to_unit(datum unit_idx, datum object_idx, short a3)
		{
			...
			assign_equipment_to_unit_t passign_equipment_to_unit = Memory::GetAddress<assign_equipment_to_unit_t>(0x1442AA, 0x1330FA);
