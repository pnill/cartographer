...
HRESULT WINAPI XLiveRender()
{
	...
	bool game_is_main_menu = s_main_game_globals::get()->game_is_mainmenu();
...
#pragma endregion achievement rendering
	...
	if (displayXyz && (NetworkSession::LocalPeerIsSessionHost() || s_main_game_globals::game_is_campaign())) {
		int text_y_coord = 60;
