...
static_assert(EXECUTABLE_VERSION < 65535 && EXECUTABLE_VERSION > 0, "EXECUTABLE_VERSION MAX VALUE EXCEEDS 65534");
static_assert(COMPATIBLE_VERSION < 65535 && COMPATIBLE_VERSION > 0, "COMPATIBLE_VERSION MAX VALUE EXCEEDS 65534");

// DO NOT CHANGE, DO NOT USE TYPES ABOVE 7 OR BELLOW 0 (3 bits values max)
#define EXECUTABLE_TYPE 4
static_assert(EXECUTABLE_TYPE <= 7 && EXECUTABLE_TYPE >= 0, "EXECUTABLE_TYPE MAX VALUE EXCEEDS 7 OR BELLOW 0");
