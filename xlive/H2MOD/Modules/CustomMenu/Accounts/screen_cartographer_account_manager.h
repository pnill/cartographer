...
static void get_label(e_cartographer_account_manager_screen_type screen_type, int32 label_id, wchar_t** out_label)
{
...
private:
	...
	int field_2C0;
	c_slot2<c_account_edit_list, s_event_record*, int32> m_slot_2;
...
public:
	...
	c_account_edit_list(uint16 _flags, int32 _button_count, int32 _default_selected_button, e_cartographer_account_manager_screen_type _screen_type);
	~c_account_edit_list()
	{
		...
		if (text_widget)
		{
			...
			case _cartographer_account_manager_screen_type_list_remove_account:
			{
				...
				if (button_count_allocated > default_button_count)
				{
					...
					if (list_item_index > button_count_allocated - 1 - 4)
					{
						...
						get_label(_cartographer_account_manager_screen_type_list, k_screen_type_account_list_button_text_index + label_index, &button_label);
					}
					else
					{
						...
						{
							get_label(_cartographer_account_manager_screen_type_list, _screen_type_account_list_button_unnamed_account, &button_label);
						}
					}
				}
				else
			...
			case _cartographer_account_manager_screen_type_create_account:
				...
				case _screen_type_account_create_button_placeholder_password_text:
					...
					break;
				default:
					get_label(m_cartographer_screen_type, k_screen_type_account_create_button_text_index + list_item_index, &button_label);
					break;
				}
				break;
			case _cartographer_account_manager_screen_type_add_account:
				...
				case _screen_type_account_add_button_remember_me_text:
					get_label(m_cartographer_screen_type, k_screen_type_account_add_button_text_index + list_item_index + (m_account_add.remember_me ? 0 : 1), &button_label);
					break;
				case _screen_type_account_add_button_login_text:
					get_label(m_cartographer_screen_type, k_screen_type_account_add_button_text_index + list_item_index + 1, &button_label);
					break;
				}
				break;
			case _cartographer_account_manager_screen_type_none:
...
//static_assert(offsetof(c_account_edit_list, m_slot_2) == 708);
//static_assert(offsetof(c_account_edit_list, m_list_data) == 112);
//static_assert(offsetof(c_account_edit_list, gap_70[56]) == 172);

class c_account_list_menu : protected c_screen_with_menu
{
private:
	c_account_edit_list m_account_edit_list;
	e_cartographer_account_manager_screen_type m_cartographer_screen_type;
...
public:
	...
	static c_account_list_menu* __cdecl open_account_create_context();
	static c_account_list_menu* __cdecl open_account_add_context();
	static c_account_list_menu* __cdecl open_account_list_context();
	static c_account_list_menu* __cdecl open_account_remove_from_list_context();

	static void* __cdecl open(s_screen_parameters* a1);
	static void* __cdecl open_default_context(s_screen_parameters* a1);

	c_account_list_menu(e_user_interface_channel_type _ui_channel, e_user_interface_render_window _window_index, uint16 _flags, e_cartographer_account_manager_screen_type _screen_type, int32 _button_count, int32 _selected_button);
	...
	~c_account_list_menu()
	{
		...
		case _cartographer_account_manager_screen_type_list_remove_account:
			break;
		case _cartographer_account_manager_screen_type_create_account:
			if (c_account_list_menu::accountingGoBackToList
				&& c_account_list_menu::IsAccountingActiveHandle())
			{
	...
	virtual void initialize(s_screen_parameters* screen_parameters) override
	{
		...
		case _cartographer_account_manager_screen_type_list:
		case _cartographer_account_manager_screen_type_list_remove_account:
			get_label(_cartographer_account_manager_screen_type_list, _screen_type_account_list_header_text, &header_text);
			get_label(_cartographer_account_manager_screen_type_list, _screen_type_account_list_subheader_text, &subheader_text);
			break;
		case _cartographer_account_manager_screen_type_create_account:
			get_label(m_cartographer_screen_type, _screen_type_account_create_header_text, &header_text);
			get_label(m_cartographer_screen_type, _screen_type_account_create_subheader_text, &subheader_text);
			break;
		case _cartographer_account_manager_screen_type_add_account:
			get_label(m_cartographer_screen_type, _screen_type_account_add_header_text, &header_text);
			get_label(m_cartographer_screen_type, _screen_type_account_add_subheader_text, &subheader_text);
			break;
		case _cartographer_account_manager_screen_type_none:
		case _carrographer_account_manager_screen_type_end:
		default:
	...
	{
		return c_account_list_menu::open_default_context;
	}
};
// ASSERT_STRUCT_SIZE(c_account_list_menu, 3396);