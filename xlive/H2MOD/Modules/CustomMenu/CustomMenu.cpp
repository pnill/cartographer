...
void __stdcall CMLabelButtons_EscSettings(int a1, int a2)
{
	...
	if (v3)
	{
		set_widget_label_from_string_id_reimpl(v3, button_id + 1, CMLabelMenuId_EscSettings);
	}
}
...
void __stdcall CMLabelButtons_Error(int a1, int a2)
{
	...
	if (v3)
	{
		set_widget_label_from_string_id_reimpl(v3, button_id + 1, CMLabelMenuId_Error);
	}
}
...
void __stdcall CMLabelButtons_EditCrosshair(int a1, int a2)
{
	...
	if (v3)
	{
		set_widget_label_from_string_id_reimpl(v3, button_id + 1, CMLabelMenuId_EditCrosshair);
	}
}
...
void __stdcall CMLabelButtons_EditFOV(int a1, int a2)
{
	...
	if (v3)
	{
		set_widget_label_from_string_id_reimpl(v3, button_id + 1, CMLabelMenuId_EditFOV);
	}
}
...
void __stdcall CMLabelButtons_EditVehicleFOV(int a1, int a2)
{
	...
	if (v3)
	{
		set_widget_label_from_string_id_reimpl(v3, button_id + 1, CMLabelMenuId_VehicleEditFOV);
	}
}
...
void __stdcall CMLabelButtons_EditHz(int a1, int a2)
{
	...
	if (v3)
	{
		set_widget_label_from_string_id_reimpl(v3, button_id + 1, CMLabelMenuId_EditHz);
	}
}
...
void __stdcall CMLabelButtons_EditFPS(int a1, int a2)
{
	...
	if (v3)
	{
		set_widget_label_from_string_id_reimpl(v3, button_id + 1, CMLabelMenuId_EditFPS);
	}
}
...
void __stdcall CMLabelButtons_EditStaticLoD(int a1, int a2)
{
	...
	if (v3)
	{
		set_widget_label_from_string_id_reimpl(v3, button_id + 1, CMLabelMenuId_EditStaticLoD);
	}
}
...
void __stdcall CMLabelButtons_EditCrosshairSize(int a1, int a2)
{
	...
	if (v3)
	{
		set_widget_label_from_string_id_reimpl(v3, button_id + 1, CMLabelMenuId_EditCrosshairSize);
	}
}
...
void __stdcall CMLabelButtons_EditHudGui(int a1, int a2)
{
	...
	if (v3)
	{
		set_widget_label_from_string_id_reimpl(v3, button_id + 1, CMLabelMenuId_EditHudGui);
	}
}
...
void __stdcall CMLabelButtons_ToggleSkulls(int a1, int a2)
{
	...
	if (v3)
	{
		set_widget_label_from_string_id_reimpl(v3, button_id + 1, CMLabelMenuId_ToggleSkulls);
	}
}
...
void __stdcall CMLabelButtons_OtherSettings(int a1, int a2)
{
	...
	if (v3)
	{
		set_widget_label_from_string_id_reimpl(v3, button_id + 1, CMLabelMenuId_OtherSettings);
	}
}
...
void __stdcall CMLabelButtons_AdvSettings(int a1, int a2)
{
	...
	if (v3)
	{
		set_widget_label_from_string_id_reimpl(v3, button_id + 1, CMLabelMenuId_AdvSettings);
	}
}
...
void __stdcall CMLabelButtons_AdvLobbySettings(int a1, int a2)
{
	...
	if (v3)
	{
		set_widget_label_from_string_id_reimpl(v3, button_id + 1, CMLabelMenuId_AdvLobbySettings);
	}
}
...
void __stdcall CMLabelButtons_AccountCreate(int a1, int a2)
{
	...
	if (v3)
	{
		set_widget_label_from_string_id_reimpl(v3, button_id + 1, CMLabelMenuId_AccountCreate);
	}
}
...
void __stdcall CMLabelButtons_AccountList(int a1, int a2)
{
	...
	if (v3)
	{
		set_widget_label_from_string_id_reimpl(v3, button_id + 1, CMLabelMenuId_AccountList);
	}
}*/
...
int __cdecl CustomMenu_CallHead(int a1, DWORD* menu_vftable_1, DWORD* menu_vftable_2, DWORD menu_button_handler, int number_of_buttons, int menu_wgit_type)
{
	int(__cdecl* sub_20B8C3)(BYTE*, int) = (int(__cdecl*)(BYTE*, int))((char*)H2BaseAddr + 0x20B8C3);
