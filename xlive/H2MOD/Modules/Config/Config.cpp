...
float H2Config_Magnum_WeaponOffsetX = 0.03;
float H2Config_Magnum_WeaponOffsetY = 0;
float H2Config_Magnum_WeaponOffsetZ = -0.005;
float H2Config_SMG_WeaponOffsetX = 0.02;
float H2Config_SMG_WeaponOffsetY = 0;
float H2Config_SMG_WeaponOffsetZ = 0;
float H2Config_Sniper_WeaponOffsetX = 0.01;
float H2Config_Sniper_WeaponOffsetY = 0;
float H2Config_Sniper_WeaponOffsetZ = 0;
