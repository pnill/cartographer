...
extern float H2Config_Magnum_WeaponOffsetX;
extern float H2Config_Magnum_WeaponOffsetY;
extern float H2Config_Magnum_WeaponOffsetZ;
extern float H2Config_SMG_WeaponOffsetX;
extern float H2Config_SMG_WeaponOffsetY;
extern float H2Config_SMG_WeaponOffsetZ;
extern float H2Config_Sniper_WeaponOffsetX;
extern float H2Config_Sniper_WeaponOffsetY;
extern float H2Config_Sniper_WeaponOffsetZ;
