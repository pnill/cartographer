...
data_decode_string bitstream::p_data_decode_string() {
	return h2mod->GetPointer<data_decode_string>(0xD1FA7, 0xCE561);
}
...
data_decode_bits bitstream::p_data_decode_bits() {
	return h2mod->GetPointer<data_decode_bits>(0xD1F95, 0xCE54F);
}

data_decode_integer bitstream::p_data_decode_integer() {
	return h2mod->GetPointer<data_decode_integer>(0xD1EE5, 0xCE49F);
}

data_decode_bool bitstream::p_data_decode_bool() {
	return h2mod->GetPointer< data_decode_bool>(0xD1F47, 0xCE501);
}

data_encode_integer bitstream::p_data_encode_integer() {
	return h2mod->GetPointer<data_encode_integer>(0xD17C6, 0xCDD80);
}

data_encode_string bitstream::p_data_encode_string() {
	return h2mod->GetPointer<data_encode_string>(0xD18DF, 0xCDE99);
}

data_encode_bits bitstream::p_data_encode_bits() {
	return h2mod->GetPointer<data_encode_bits>(0xD18CD, 0xCDE87);
}

data_encode_boolean bitstream::p_data_encode_bool() {
	return h2mod->GetPointer<data_encode_boolean>(0xD1886, 0xCDE40);
}

valid_packet_type bitstream::p_packet_is_valid() {
	return h2mod->GetPointer<valid_packet_type>(0xD114C, 0xCD706);
}
