...
void HitFix::Initialize()
{
	...
	*(float*)(AddressOffset + 0xA4EC88) = 1200.0f;	//battle_rifle_bullet.proj Initial Velocity 400
	*(float*)(AddressOffset + 0xA4EC8C) = 1200.0f;	//battle_rifle_bullet.proj Final Velocity 400
	*(float*)(AddressOffset + 0xB7F914) = 4000.0f;	//sniper_bullet.proj Initial Velocity 1200
	*(float*)(AddressOffset + 0xB7F918) = 4000.0f;	//sniper_bullet.proj Final Velocity 1200
	
	//FIXME COOP will break because of one of these tags not existing.
	*(float*)(AddressOffset + 0xCE4598) = 4000.0f;	//beam_rifle_beam.proj Initial Velocity 1200
	*(float*)(AddressOffset + 0xCE459C) = 4000.0f;	//beam_rifle_beam.proj Final Velocity 1200
