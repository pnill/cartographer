...
void HitFix::Deinitialize()
{
	...
	*(float*)(AddressOffset + 0xA4EC88) = 400.0f; // battle_rifle_bullet.proj Initial Velocity 
	*(float*)(AddressOffset + 0xA4EC8C) = 400.0f; //battle_rifle_bullet.proj Final Velocity
	*(float*)(AddressOffset + 0xA84DD4) = 400.0f; //carbine_projectile Initial Velocity 400
	*(float*)(AddressOffset + 0xA84DD8) = 400.0f; //carbine_projectile Final Velocity 400
	*(float*)(AddressOffset + 0xB7F914) = 1200.0f; //sniper_bullet.proj Initial Velocity
	*(float*)(AddressOffset + 0xB7F918) = 1200.0f; //sniper_bullet.proj Final Velocity

	//FIXME COOP will break because of one of these tags not existing.
	*(float*)(AddressOffset + 0xCE4598) = 1200.0f; //beam_rifle_beam.proj Initial Velocity
	*(float*)(AddressOffset + 0xCE459C) = 1200.0f; //beam_rifle_beam.proj Final Velocity
	*(float*)(AddressOffset + 0x81113C) = 90.0f; //gauss_turret.proj Initial Velocity def 90
	*(float*)(AddressOffset + 0x811140) = 90.0f; //gauss_turret.proj Final Velocity def 90
	*(float*)(AddressOffset + 0x97A194) = 400.0f; //magnum_bullet.proj initial def 400
	*(float*)(AddressOffset + 0x97A198) = 400.0f; //magnum_bullet.proj final def 400
	*(float*)(AddressOffset + 0x7E7E20) = 800.0f; //bullet.proj (chaingun) initial def 800
	*(float*)(AddressOffset + 0x7E7E24) = 800.0f; //bullet.proj (chaingun) final def 800
}