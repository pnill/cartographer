...
public:
	...
	static void setZombiePlayerStatus(unsigned long long identifier, unsigned long absPlayerIdx);
	...
	static void PreOnPlayerDeathClientCode(const unsigned long absPlayerIdx);
	static void PreOnPlayerDeathHostCode(const unsigned long absPlayerIdx);
	static void PreOnPlayerSpawnClientCode(const unsigned long absPlayerIdx);
	static void PostOnPlayerSpawnClientCode(const unsigned long absPlayerIdx);
	static void PostOnPlayerSpawnHostCode(const unsigned long absPlayerIdx);
