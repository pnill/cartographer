...
void __cdecl draw_string_set_unknown_color(real_argb_color const* color);
...
void __cdecl draw_string_calculate_bounds(rectangle2d* bounds, wchar_t* string, int32* out_unk, int32* out_unk_2, real32 scale);
