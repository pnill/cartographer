...
void c_bitstream::read_string_wchar(const char* name, void* string, int size_in_words)
{
	typedef void(__thiscall* data_encode_string_t)(c_bitstream*, const char*, void*, int);
...
void c_bitstream::write_string_wchar(const char* name, void* string_buffer, int size_in_words)
{
	typedef void(__thiscall* data_decode_string_t)(c_bitstream*, const char*, void*, int);
...
void c_bitstream::write_integer(const char* name, unsigned int value, unsigned int size_in_bits)
{
	typedef void(__thiscall* data_encode_integer_t)(c_bitstream*, const char*, unsigned int, int);
...
{
	typedef int32(__thiscall* data_decode_integer_t)(c_bitstream*, const char*, uint32);
...
void c_bitstream::data_encode_bits(const char* name, void* data, unsigned int size_in_bits)
{
	typedef void(__thiscall* data_encode_bits_t)(c_bitstream*, const char*, void*, int);
...
void c_bitstream::data_decode_bits(const char* name, void* data, int size_in_bits)
{
	typedef void(__thiscall* data_decode_bits_t)(c_bitstream*, const char*, void*, int);
...
void c_bitstream::data_encode_bool(const char* name, bool value)
{
	typedef void(__thiscall* data_encode_bool_t)(c_bitstream*, const char*, bool);
	auto p_data_encode_bool = Memory::GetAddress<data_encode_bool_t>(0xD1886, 0xCDE40);
	p_data_encode_bool(this, name, value);
}

bool c_bitstream::data_decode_bool(const char* name)
{
	typedef bool(__thiscall* data_decode_bool_t)(c_bitstream*, const char*);
...
void c_bitstream::data_encode_quantized_real(const char* name, float value, float min_value, float max_value, int size_in_bits, char exact_midpoint)
{
	typedef void(__thiscall* data_encode_quantized_real_t)(c_bitstream*, const char*, float, float, float, int, char);
...
float c_bitstream::data_decode_quantized_real(const char* name, float min_value, float max_value, int size_in_bits, char exact_midpoint)
{
	typedef float(__thiscall* data_decode_quantized_real_t)(c_bitstream*, const char*, float, float, int, char);
...
void c_bitstream::data_encode_flags(const char* name, unsigned long long value, int size_in_bits)
{
	typedef void(__thiscall* data_encode_flags_t)(c_bitstream*, const char*, unsigned long long, int);
...
unsigned long long c_bitstream::data_decode_flags(const char* name, int size_in_bits)
{
	typedef unsigned long long(__thiscall* data_decode_flags_t)(c_bitstream*, const char*, int);
