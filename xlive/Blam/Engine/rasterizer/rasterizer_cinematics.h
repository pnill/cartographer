...
enum
{
	k_screen_effect_script_value_count = 4,
	k_cinematic_layer_count = 32,
};
...
real32 rasterizer_get_near_clip_distance(void);

real32 rasterizer_get_far_clip_distance(void);

real32 rasterizer_cinematics_get_gamma_ramp(void);
