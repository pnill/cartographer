...
protected:
	...
	bool handle_item_campaign(s_event_record** pevent);
	bool handle_item_xbox_live(s_event_record** pevent);
	bool handle_item_splitscreen(s_event_record** pevent);
	bool handle_item_system_link(s_event_record** pevent);
	bool handle_item_settings(s_event_record** pevent);
	//bool handle_item_guide(s_event_record** pevent);
	bool handle_item_quit(s_event_record** pevent);
