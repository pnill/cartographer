...
public:
	...
	virtual uint32 read_creation_from_packet(int32 entity_index, e_simulation_entity_type* simulation_entity_type, uint32* out_update_mask, int32 a5, uint32* a6, s_replication_allocation_block* a7, c_bitstream* packet);
