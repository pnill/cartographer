...
enum __MIDL_kablam_commands_interface_0002
    {
        status_result_code_offine_initializing	= 0,
        status_result_code_offline_product_key_required	= 0x1,
        status_result_code_offline_invalid_product_key	= 0x2,
        status_result_code_server_banned	= 0x3,
        status_result_code_update_required	= 0x4,
        status_result_code_offline	= 0x5,
        status_result_code_signing_in	= 0x6,
        status_result_code_signin_out	= 0x7,
        status_result_code_connecting	= 0x8,
        status_result_code_offline_waiting_to_reconnect	= 0x9,
        status_result_code_offline_signin_failed	= 0xa,
        status_result_code_offline_disconnected	= 0xb,
        status_result_code_online_no_playlist	= 0xc,
        status_result_code_online_failed_to_load_playlist	= 0xd,
        status_result_code_online_empty_playlist	= 0xe,
        status_result_code_online_pregame_lobby	= 0xf,
        status_result_code_online_starting_game	= 0x10,
        status_result_code_online_game_in_progress	= 0x11,
        status_result_code_online_game_over	= 0x12,
        status_result_code_online_postgame_carnage_report	= 0x13,
        k_status_result_code_count	= 0x14
    } 	e_kablam_command_status_result_code;

typedef /* [public][public][public][v1_enum] */ 
enum __MIDL_kablam_commands_interface_0003
    {
        status_response_flag_lobby_info	= 0,
        status_response_flag_live	= 1,
        status_response_flag_xlive_signin_result	= 2,
        status_response_flag_signin_mode	= 3,
        status_response_flag_has_gamertag	= 4,
        status_response_flag_has_lan_name	= 5,
        status_response_flag_has_playlist_path	= 6
    } 	e_kablam_command_status_response_flags;

typedef /* [public][public] */ 
enum __MIDL_kablam_commands_interface_0004
    {
        kick_player_response_player_kicked	= 0,
        kick_player_response_server_not_running	= 0x1,
        kick_player_response_player_not_found	= 0x2
    } 	kablam_command_kick_result_code;

typedef /* [public][public][public][public][public] */ 
enum __MIDL_kablam_commands_interface_0005
    {
        name_result_code_success	= 0,
        name_result_code_lan_only	= 0x1,
        name_result_code_invalid_utf16	= 0x2
    } 	e_kablam_command_set_unicode_setting_result_code;

typedef /* [public][public][public] */ 
enum __MIDL_kablam_commands_interface_0006
    {
        play_error_playlist_read_failed	= 0,
        play_error_file_not_found	= 0x1,
        play_error_file_open_access_denied	= 0x2,
        play_error_playlist_no_valid_matches	= 0x4
...
enum __MIDL_kablam_commands_interface_0008
    {
        send_message_result_code_sent	= 0,
        send_message_result_code_server_not_active	= 0x2,
        send_message_result_code_no_players_in_session	= 0x3,
        send_message_result_code_message_failed	= 0x4
    } 	e_kablam_command_send_message_result_code;

typedef /* [public][public] */ 
enum __MIDL_kablam_commands_interface_0009
    {
        live_key_response_code_product_key_set	= 0,
        live_key_response_code_key_invalid	= 0x1,
        live_key_response_code_key_set_failed	= 0x2
    } 	e_kablam_command_live_key_response_code;

typedef /* [public][public] */ 
enum __MIDL_kablam_commands_interface_0010
    {
        live_auto_signin_response_code_auto_signin_enabled	= 0,
        live_auto_signin_response_code_auto_signin_failed	= 0x1,
        live_auto_signin_response_code_live_only	= 0x2
    } 	e_kablam_command_live_auto_signin_response_code;

typedef /* [public][public] */ 
enum __MIDL_kablam_commands_interface_0011
    {
        live_signin_result_code_success	= 0,
        live_signin_result_code_live_only	= 0x1
    } 	e_kablam_command_live_signin_result_code;

typedef /* [public][public] */ 
enum __MIDL_kablam_commands_interface_0012
    {
        live_signout_result_code_signing_out_live	= 0,
        live_signout_result_code_not_signed_in	= 0x1,
        live_signout_result_code_live_only	= 0x2
    } 	e_kablam_command_live_signout_result_code;

typedef /* [public][public][public][public][public] */ 
enum __MIDL_kablam_commands_interface_0013
    {
        ban_network_result_code_success	= 0,
        ban_network_result_code_lan_only	= 0x1,
        ban_network_result_code_ban_list_full	= 0x2,
        ban_network_result_code_ban_not_found	= 0x3
    } 	e_kablam_command_ban_network_result_code;

typedef /* [public][public][public][public][public] */ 
enum __MIDL_kablam_commands_interface_0014
    {
        gamer_table_result_code_success	= 0,
        gamer_table_result_code_live_only	= 0x1,
        gamer_table_result_code_table_full	= 0x2,
        gamer_table_result_code_gamer_not_found	= 0x3
...
enum __MIDL_kablam_commands_interface_0015
    {
        unban_all_ip	= 0,
        unban_all_nic	= 0x1,
        unban_all_gamertags	= 0x2
    } 	e_kablam_unban_all_type;

typedef /* [public][public] */ 
enum __MIDL_kablam_commands_interface_0016
    {
        unban_all_result_code_success	= 0,
        unban_all_result_code_failed	= 0x1
    } 	e_kablam_command_unban_all_result_code;

typedef /* [public][public] */ 
enum __MIDL_kablam_commands_interface_0017
    {
        vip_clear_result_code_success	= 0,
        vip_clear_result_code_live_only	= 0x1
    } 	e_kablam_command_vip_clear_result_code;

typedef /* [public][public][public] */ 
enum __MIDL_kablam_commands_interface_0018
    {
        stats_folder_result_code_success	= 0,
        stats_folder_result_code_invalid	= 0x1,
        stats_folder_result_code_not_writable	= 0x2,
        stats_folder_result_code_export_disabled	= 0x3
    } 	e_kablam_command_stats_folder_result_code;

typedef /* [public][public][public] */ 
enum __MIDL_kablam_commands_interface_0019
    {
        kablam_command_privacy_open	= 0,
        kablam_command_privacy_gold	= 0x1,
        kablam_command_privacy_vip	= 0x2,
        k_kablam_command_privacy_type_count	= ( kablam_command_privacy_vip + 1 ) ,
        kablam_command_privacy_none	= -1
    } 	e_kablam_command_privacy_type;

typedef /* [public][public][public] */ 
enum __MIDL_kablam_commands_interface_0020
    {
        privacy_result_code_success	= 0,
        privacy_result_code_live_only	= 0x1
    } 	e_kablam_command_privacy_result_code;

typedef /* [public][public] */ 
enum __MIDL_kablam_commands_interface_0021
    {
        set_max_players_result_code_success	= 0,
        set_max_players_result_code_out_of_range	= 0x1
