...
extern const MIDL_SERVER_INFO kablam_commands_interface_ServerInfo;

extern const RPC_DISPATCH_TABLE kablam_commands_interface_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE kablam_commands_interface___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0x0a8c5d7f,0x2550,0x40da,{0xb3,0x57,0xe1,0xfd,0x83,0xdb,0xe3,0x93}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&kablam_commands_interface_v1_0_DispatchTable,
    0,
    0,
    0,
    &kablam_commands_interface_ServerInfo,
    0x06000000
    };
RPC_IF_HANDLE kablam_commands_interface_v1_0_s_ifspec = (RPC_IF_HANDLE)& kablam_commands_interface___RpcServerInterface;
#ifdef __cplusplus
namespace {
#endif
...
static const RPC_DISPATCH_FUNCTION kablam_commands_interface_table[] =
    {
    NdrServerCall2,
    NdrServerCall2,
    NdrServerCall2,
...
static const RPC_DISPATCH_TABLE kablam_commands_interface_v1_0_DispatchTable = 
    {
    36,
    (RPC_DISPATCH_FUNCTION*)kablam_commands_interface_table
    };
...
static const MIDL_STUB_DESC kablam_commands_interface_StubDesc = 
    {
    (void *)& kablam_commands_interface___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
    ...
    0x2000001, /* MIDL flag */
    0, /* cs routines */
    (void *)& kablam_commands_interface_ServerInfo,   /* proxy/server info */
    0
    };
#ifdef __cplusplus
}
...
static const RPC_DISPATCH_FUNCTION kablam_commands_interface_NDR64__table[] =
    {
    NdrServerCallAll,
    NdrServerCallAll,
    NdrServerCallAll,
...
static const RPC_DISPATCH_TABLE kablam_commands_interface_NDR64__v1_0_DispatchTable = 
    {
    36,
    (RPC_DISPATCH_FUNCTION*)kablam_commands_interface_NDR64__table
    };
...
static const MIDL_SYNTAX_INFO kablam_commands_interface_SyntaxInfo [  2 ] = 
    ...
    ,{
    {{0x71710533,0xbeba,0x4937,{0x83,0x19,0xb5,0xdb,0xef,0x9c,0xcc,0x36}},{1,0}},
    (RPC_DISPATCH_TABLE*)&kablam_commands_interface_NDR64__v1_0_DispatchTable,
    0 ,
...
static const SERVER_ROUTINE kablam_commands_interface_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)kablam_command_get_version_rpc,
    (SERVER_ROUTINE)kablam_command_kill_server_rpc,
    (SERVER_ROUTINE)kablam_command_skip_rpc,
    (SERVER_ROUTINE)kablam_command_kick_rpc,
    (SERVER_ROUTINE)kablam_command_status_rpc,
    (SERVER_ROUTINE)kablam_command_get_name_rpc,
    (SERVER_ROUTINE)kablam_command_set_name_rpc,
    (SERVER_ROUTINE)kablam_command_get_description_rpc,
    (SERVER_ROUTINE)kablam_command_set_description_rpc,
    (SERVER_ROUTINE)kablam_command_send_message_rpc,
    (SERVER_ROUTINE)kablam_command_play_rpc,
    (SERVER_ROUTINE)kablam_command_playing_rpc,
    (SERVER_ROUTINE)kablam_command_live_activate_rpc,
    (SERVER_ROUTINE)kablam_command_live_auto_signin_rpc,
    (SERVER_ROUTINE)kablam_command_live_signin_rpc,
    (SERVER_ROUTINE)kablam_command_live_signout_rpc,
    (SERVER_ROUTINE)kablam_command_ban_ip_rpc,
    (SERVER_ROUTINE)kablam_command_ban_nic_rpc,
    (SERVER_ROUTINE)kablam_command_ban_gamer_rpc,
    (SERVER_ROUTINE)kablam_command_unban_ip_rpc,
    (SERVER_ROUTINE)kablam_command_unban_nic_rpc,
    (SERVER_ROUTINE)kablam_command_unban_gamer_rpc,
    (SERVER_ROUTINE)kablam_command_unban_all_rpc,
    (SERVER_ROUTINE)kablam_command_get_ban_ip_rpc,
    (SERVER_ROUTINE)kablam_command_get_ban_nic_rpc,
    (SERVER_ROUTINE)kablam_command_get_ban_gamer_rpc,
    (SERVER_ROUTINE)kablam_command_vip_add_rpc,
    (SERVER_ROUTINE)kablam_command_vip_remove_rpc,
    (SERVER_ROUTINE)kablam_command_vip_clear_rpc,
    (SERVER_ROUTINE)kablam_command_get_vip_rpc,
    (SERVER_ROUTINE)kablam_command_get_stats_folder_rpc,
    (SERVER_ROUTINE)kablam_command_set_stats_folder_rpc,
    (SERVER_ROUTINE)kablam_command_set_privacy_rpc,
    (SERVER_ROUTINE)kablam_command_get_privacy_rpc,
    (SERVER_ROUTINE)kablam_command_set_max_players_rpc,
    (SERVER_ROUTINE)kablam_command_get_max_players_rpc
    };

static const MIDL_SERVER_INFO kablam_commands_interface_ServerInfo = 
    {
    &kablam_commands_interface_StubDesc,
    kablam_commands_interface_ServerRoutineTable,
    kablam_commands__MIDL_ProcFormatString.Format,
    (unsigned short *) kablam_commands_interface_FormatStringOffsetTable,
    0,
