...
bool kablam_command_parse_ip_cidr(wchar_t* address_string, struct s_ipv4_subnet* ipv4_subnet);

bool kablam_command_parse_mac_address(wchar_t* mac_string, struct s_mac_address* out_mac);