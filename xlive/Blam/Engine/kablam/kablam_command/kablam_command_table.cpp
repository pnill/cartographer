...
#define CREATE_KABLAM_COMMAND_DEFINITION(command_name, class) \
	kablam_command_definition \
	{ \
		command_name, \
		class::create_instance, \
		class::print_help_text, \
		class::parse_response \
	}


static kablam_command_definition g_command_table[k_kablam_command_table_count]
{
