...
namespace FiloInterface
{
	...
	void init_filo(filo *data, std::string path, bool mode)
	{
		...
		DWORD func_offset = SwitchServerClient(0x632F1, 0x655F1);
	...
	bool delete_existing(filo *data)
	{
		...
		DWORD func_offset = SwitchServerClient(0x63667, 0x65967);
	...
	bool check_access(filo *data)
	{
		...
		DWORD func_offset = SwitchServerClient(0x632F1, 0x0);
	...
	bool open(filo *data, __int16 mode, DWORD *error_code)
	{
		...
		DWORD func_offset = SwitchServerClient(0x638BF, 0x65BBF);
	...
	bool close(filo *data)
	{
		...
		DWORD func_offset = SwitchServerClient(0x63B66, 0x65E66);
