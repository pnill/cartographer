...
public:
	...
	virtual int8 sub_A90039(s_simulation_game_entity* entity) = 0;
	virtual int8 get_object_index(s_simulation_game_entity* entity) = 0;
	virtual int32  sub_A9004D(int a1, int a2, DWORD a3);
	...
	virtual int32 calculate_update_relevance(int a1, int a2, DWORD* a3);
