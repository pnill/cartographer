...
void cartographer_player_profile_load(e_controller_index controller_index, uint32 enumerated_file_index)
{
	...
	{
		saved_games_cartographer_player_profile_v1_new(&g_cartographer_profile_settings[controller_index]);
...
{
	for (auto& g_cartographer_profile_setting : g_cartographer_profile_settings)
		saved_games_cartographer_player_profile_v1_new(&g_cartographer_profile_setting);
}
