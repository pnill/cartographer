...
bool s_network_channel::GetNetworkAddressFromNetworkChannel(network_address* out_addr)
{
	...
	get_network_address_from_network_channel_t p_get_network_address_from_network_channel = Memory::GetAddress<get_network_address_from_network_channel_t>(0x1BA543, 0x1C9364);
