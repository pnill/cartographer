...
e_game_life_cycle __cdecl get_game_life_cycle(void)
{
...
void __cdecl c_game_life_cycle_handler_joining::check_joining_capability(void)
{
	INVOKE(0x1AD643, 0x1A65C0, c_game_life_cycle_handler_joining::check_joining_capability);
}

bool c_game_life_cycle_manager::game_life_cycle_initialized(void)
{
	return *Memory::GetAddress<bool*>(0x420FC0, 0x3C40A8);
}

c_game_life_cycle_manager* c_game_life_cycle_manager::get(void)
{
	return Memory::GetAddress<c_game_life_cycle_manager*>(0x420FC4, 0x3C40AC);
}

e_game_life_cycle c_game_life_cycle_manager::get_life_cycle(void) const
{
...
bool c_game_life_cycle_manager::state_is_joining(void) const
{
	bool result = false;
	if (!game_life_cycle_initialized())
	{
	...
	else if (life_cycle_state == _life_cycle_joining)
	{
		result = true;
	}
...
bool c_game_life_cycle_manager::state_is_in_game(void) const
{
	...
	else if (life_cycle_state == _life_cycle_in_game)
	{
		result = true;
	}
	return result;
